...
- If you are using **`Archcraft`** (`Required: 2023 or later`) as your OS, You can just install one of the provided package with : `sudo pacman -U archcraft-hyprland-6.0-0-any.pkg.tar.zst` or `sudo pacman -U archcraft-hyprland-catppuccin-6.0-0-any.pkg.tar.zst` whichever style you like.
